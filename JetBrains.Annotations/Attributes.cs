// The file Attributes.cs is part of JetBrains.Annotations.
// 
...
//  along with JetBrains.Annotations If not, see <http://www.gnu.org/licenses/>.

#region

// --------------------------------------------------------------------------------------------------------------------
// <copyright company="Tauron Parallel Works" file="Attributes.cs">
//   Copyright (C) 2013 Tauron
//   
...
namespace Tauron.JetBrains.Annotations
{
    /// <summary>
    ///     Indicates that marked element should be localized or not.
    /// </summary>
    ...
    public sealed class StringFormatMethodAttribute : Attribute
    {
        ...
        ///     Initialisiert eine neue Instanz der <see cref="StringFormatMethodAttribute" /> Klasse.
        ///     Initializes a new instance of the <see cref="StringFormatMethodAttribute" /> class.
    ...
    public sealed class BaseTypeRequiredAttribute : Attribute
    {
        ...
        ///     Initialisiert eine neue Instanz der <see cref="BaseTypeRequiredAttribute" /> Klasse.
        ///     Initializes a new instance of the <see cref="BaseTypeRequiredAttribute" /> class.
