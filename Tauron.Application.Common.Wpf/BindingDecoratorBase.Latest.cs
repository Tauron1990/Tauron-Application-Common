...
namespace Tauron.Application
{
  ...
  public abstract class BindingDecoratorBase : MarkupExtension
  {
    ...
    [CanBeNull,TypeConverter(typeof(CultureInfoIetfLanguageTagConverter)), DefaultValue(null)]
    ...
    [CanBeNull, DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
