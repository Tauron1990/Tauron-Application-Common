// The file CommandBinder.cs is part of Tauron.Application.Common.Wpf.
// 
...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommandBinder.cs" company="Tauron Parallel Works">
...
namespace Tauron.Application
{
    ...
    public static class CommandBinder
    {
        ...
        {
            RoutedCommand val = Commands.Find(com => com.Name == name);
        ...
        public static void Register([NotNull] RoutedCommand command)
        {
            ...
            foreach (CommandLinker linker in LinkerCollection)
            {
       ...
       // [DebuggerNonUserCode]
        private class CommandLinker : PipelineBase
        {
            ...
            private class CommandFactory
            {
                ...
                {
                    Contract.Requires<ArgumentNullException>(targetObject != null, "targetObject");

                    Window window = Window.GetWindow(targetObject);
                    if (window == null || command == null) return;

                    for (int i = 0; i < window.CommandBindings.Count; i++)
                    {
                ...
                private Tuple<MethodInfo, MemberInfo> FindCommandPair([NotNull] IReflect targetType, out bool finded)
                {
                    ...
                    foreach (MemberInfo m in targetType.GetMembers(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic))
                    {
                        ...
                        string name = attr.ProvideMemberName(m);
                ...
                private class ParameterMapper
                {
                    ...
                    public ParameterMapper([NotNull] MethodInfo method, [NotNull] object firstArg)
                    {
                        ...
                        Contract.Requires<ArgumentNullException>(firstArg != null, "firstArg");
                    ...
                    public void CanExecute([NotNull] object sender, [NotNull] CanExecuteRoutedEventArgs e)
                    {
                        ...
                        object[] args = _isParameter ? new[] {e.Parameter} : new object[0];
            ...
            private class PropertySearcher
            {
                ...
                [NotNull]
                private WeakReference<DependencyObject> Target { get; set; }
