...
namespace Tauron.Application.Ioc.BuildUp
{
    ...
    public static class Helper
    {
        ...
        private static IRightable TryResolveConstructorParameter((Type Type, string Name, bool Optional) parm, IBuildContext context)
        {
            ...
            if (tempExport != null) return context.Container.DeferBuildUp(tempExport, errorTrancer, context.CompilationUnit.VariableNamer, context.Parameters);
            switch (context.Parameters)
            {
                ...
                default:
                    ...
                    if (data == null && parm.Optional)
                        ...
                        return context.Container.DeferBuildUp(data, context.ErrorTracer, context.CompilationUnit.VariableNamer, context.Parameters);
            }
        }
    }
}