...
namespace Tauron.Application
{
    ...
    {
        private bool Equals([NotNull] WeakAction other) => Equals(_method, other._method) && Equals(TargetObject?.Target, other.TargetObject?.Target);
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                return ((_method != null ? _method.GetHashCode() : 0) * 397) ^ (value == null ? 0 : value.Value);
            }
        }
