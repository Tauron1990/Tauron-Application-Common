...
namespace Tauron
{
    public class ProgressEventArgs : EventArgs
    {
        ...
        {
            Argument.NotNull(progressStatistic, nameof(progressStatistic));
    ...
    public class ProgressStatistic
    {
        ...
        {
            get => _estimatingMethod;
            set
            {
                Argument.Check(() => HasStarted ? new OperationAlreadyStartedException() : null);
        ...
        {
            Argument.Check(bytesRead <= BytesRead, () => throw new ArgumentException("Operation cannot go backwards!", nameof(bytesRead)));
            Argument.Check(HasFinished, () => throw new InvalidOperationException("Operation has finished already!"));
